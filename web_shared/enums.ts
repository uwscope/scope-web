...
export const patientGenderValues = [
  "Male",
  "Female",
  "Transgender",
...
export type DepressionTreatmentStatus =
  (typeof depressionTreatmentStatusValues)[number];

export const followupScheduleValues = [
  "1-week follow-up",
  "2-week follow-up",
  "3-week follow-up",
  "4-week follow-up",
...
export type CancerTreatmentRegimen =
  | (typeof cancerTreatmentRegimenValues)[number]
  | OtherSpecify;
...
export const treatmentChangeValues = [
  "None",
  "Medication",
  "Counseling",
] as const;
export type TreatmentChange =
  | (typeof treatmentChangeValues)[number]
  | OtherSpecify;
...
export type BehavioralActivationChecklistItem =
  (typeof behavioralActivationChecklistValues)[number];
...
export type BehavioralStrategyChecklistItem =
  | (typeof behavioralStrategyChecklistValues)[number]
  | OtherSpecify;
...
export type BAChecklistFlags = {
  [item in BehavioralActivationChecklistItem]: boolean;
};
export type BehavioralStrategyChecklistFlags = {
  [item in BehavioralStrategyChecklistItem]: boolean;
};
export type ReferralStatusFlags = { [item in Referral]: ReferralStatus };

export type CancerTreatmentRegimenFlags = {
  [item in CancerTreatmentRegimen]: boolean;
};
...
export const providerRoleValues = [
  "studyStaff",
  "psychiatrist",
  "socialWorker",
];
