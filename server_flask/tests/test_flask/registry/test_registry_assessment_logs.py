...
def test_flask_get_assessment_logs(
    ...
    """
    Test that we can get a list of assessment_logs.
    """
    ...
    assert data_fake_patient["assessmentLogs"] == response.json()
...
def test_flask_create_assessment_log(
    ...
    """
    Test that we can create a assessment log.
    """
...
def test_flask_get_assessment_log(
    ...
    """
    Test that we can get a assessment log using log_id.
    """
...
def test_flask_update_assessment_log(
    ...
    """
    Test that we can update a assessment log using log_id.
    """
