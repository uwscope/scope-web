...
import {
  ...
  PageHeaderContainer,
  PageHeaderTitle,
} from "src/components/common/Page";
...
export const CaseloadPage: FunctionComponent = observer(() => {
  ...
  const onCareManagerSelect = action(
  ...
  const onClinicSelect = action(
    (
      event: React.ChangeEvent<{
        name?: string;
        value: ClinicCode | AllClinicCode;
      }>,
    ) => {
  ...
  return (
    ...
    >
      <Page>
        ...
        <CaseloadTable
          patients={rootStore.patientsStore.filteredPatients}
