...
export const PatientCard: FunctionComponent<IPatientCardProps> = observer(
  (props) => {
      ...
      <Container>
        ...
        >
          ...
          <Grid item>
            ...
            <LabeledField
              label="clinic code"
              value={patient.profile.clinicCode}
            />
          </Grid>
          <Grid item>
            <LabeledField
              ...
              value={
                !!patient.profile.birthdate
                  ? formatDateOnly(patient.profile.birthdate, "MM/dd/yyyy")
                  : "--"
              }
            />
            <LabeledField
            ...
            <LabeledField
              label="race"
              value={
                patient.profile.race != undefined
                  ? generateRaceText(patient.profile.race)
                  : "unknown"
              }
            />
          ...
          <Grid item>
            ...
            <LabeledField
              ...
              value={patient.profile.depressionTreatmentStatus}
            />
            <LabeledField
