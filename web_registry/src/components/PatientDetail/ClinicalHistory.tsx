...
const ClinicalHistoryContent: FunctionComponent<
  IClinicalHistoryContentProps
> = (props) => {
  const {
    editable,
  ...
  return (
    <Grid container spacing={2} alignItems="stretch">
      ...
      <GridMultiSelectField
        ...
        onOtherChange={(text) =>
          onValueChange("currentTreatmentRegimenOther", text)
        }
      />
      <GridTextField
        sm={12}
...
export const ClinicalHistory: FunctionComponent = observer(() => {
  ...
  const state = useLocalObservable<{ open: boolean } & IClinicalHistory>(
    () => ({
      ...
      currentTreatmentRegimenOther:
        clinicalHistory.currentTreatmentRegimenOther || "",
      currentTreatmentRegimenNotes:
        clinicalHistory.currentTreatmentRegimenNotes || "",
  ...
  return (
    <ActionPanel
      ...
      loading={
        ...
        currentPatient?.loadClinicalHistoryState.pending
      }
