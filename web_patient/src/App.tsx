          ...
          <RouterSwitch>
            <Route
              ...
              element={
                <RouterSwitch>
                  ...
                  />
                  <Route
                    path={`/${Routes.valuesInventory}`}
                    element={<ValuesInventoryHome />}
                  />
                  <Route
            ...
            <Route
              ...
              element={
                <RouterSwitch>
                  <Route
                    path={`/${Routes.moodProgress}`}
                    element={<MoodTrackingHome />}
                  />
                  <Route
                    path={`/${Routes.activityProgress}`}
                    element={<ActivityTrackingHome />}
                  />
                  <Route
