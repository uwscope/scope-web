...
export const ActivityLoggingForm: FunctionComponent<IActivityLoggingFormProps> =
  observer(() => {
    ...
    const handleSubmit = action(async () => {
      try {
        ...
        if (dataState.success == "No") {
          const { alternative, pleasure, accomplishment, ...logData } =
            dataState;
    ...
    const getActivityLogPages = () => {
      const successPage = {
        ...
        canGoNext:
          dataState.success == "SomethingElse"
            ? !!dataState.alternative
            : !!dataState.success,
      };
      ...
      const accomplishmentPage = {
        content: (
          <PageRating
            ...
            rating={
              dataState.accomplishment != undefined
                ? dataState.accomplishment
                : 5
            }
