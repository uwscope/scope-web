const _strings = {
    ...
    Home_plan_done: 'You have completed all the planned activities for today! Make sure to celebrate your achievement!',
    Home_overdue_title: 'My plan for the past 2 weeks',
    Home_overdue_pending: 'Show pending activities',
    Home_overdue_all: 'Show all activities',
    Home_overdue_empty: 'You did not have any planned activities in the past 2 weeks.',
