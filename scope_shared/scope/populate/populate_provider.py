...
def _ensure_provider_identity(
    *,
    ...
    if not update_identity_document:
        update_identity_document = provider_identity_document["cognitoAccount"]["cognitoId"] != provider["account"]["existing"]["cognitoId"]
    if not update_identity_document:
        update_identity_document = provider_identity_document["cognitoAccount"]["email"] != provider["account"]["existing"]["email"]
