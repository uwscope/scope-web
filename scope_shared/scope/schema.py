...
recent_entry_review_schema: Optional[jschon.JSONSchema] = None
recent_entry_reviews_schema: Optional[jschon.JSONSchema] = None
...
SCHEMAS = {
    ...
    "recent_entry_review_schema": "documents/recent-entry-review.json",
    "recent_entry_reviews_schema": "documents/recent-entry-reviews.json",
